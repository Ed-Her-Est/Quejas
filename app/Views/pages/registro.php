...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            background: linear-gradient(to bottom, #338343 5%, #ffffff 50%);
            position: relative; /* Permite posicionar elementos hijos de forma absoluta */
        }
        .title {
            position: absolute; /* Posiciona el título encima del fondo */
            top: 100px; /* Posición vertical del título */
            left: 0; /* Alineación del título al centro */
            right: 0;
            text-align: center;
            font-size: 54px;
            font-weight: bold;
